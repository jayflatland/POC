...
class test03_adsb(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "test03_adsb")
        ...
        self.uhd_usrp_source_0.set_center_freq(1.09e9, 0)
        ...
        self.analog_const_source_x_0 = analog.sig_source_f(0, analog.GR_CONST_WAVE, 0, 0, (10e-3))
...
def main(top_block_cls=test03_adsb, options=None):
